<template>
  <div
    ref="navigation"
    class="navigation"
    :class="{ navigation__transparent: backgroundTransparent }"
  >
    <div class="navigation__container">
      ...
      <ul class="navigation__options">
        <li class="navigation__option">
          <Icon name="ic:baseline-search" class="navigation__option-icon" />
          <p class="navigation__option-label">Search</p>
        </li>
        <li class="navigation__option">
          <Icon
          ...
          />
          <p class="navigation__option-label">Products</p>
        </li>
        <li class="navigation__option">
          <Icon name="bi:tools" class="navigation__option-icon" />
          <p class="navigation__option-label">Services</p>
        </li>
        <li class="navigation__option">
          <Icon
            ...
            class="navigation__option-icon"
          />
          <p class="navigation__option-label">Contact</p>
        </li>
      </ul>
    </div>
  </div>
